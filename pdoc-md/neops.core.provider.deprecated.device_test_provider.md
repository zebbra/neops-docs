...
### Module functions
**test_sub_sub_task**(__task: nornir.core.task.Task,res: str__) -> __nornir.core.task.Result__
**test_sub_task**(__task: nornir.core.task.Task,res: str__) -> __nornir.core.task.Result__
## DeviceTestProvider
```
